...
<table>
  ...
  <tbody>
    <tr>
      <td>View own live URL details</td>
      <td>`Live Url (individual) > View`</td>
    </tr>
    <tr>
      <td>Create live URLs and update their properties</td>
      <td>`Live Url (individual) > Modify`</td>
    </tr>
    <tr>
      <td>Revoke own live URLs</td>
      <td>`Live Url (individual) > Delete`</td>
    </tr>
    <tr>
      <td>View all live URL details in the account</td>
      <td>`Live Url (all) > View`</td>
    </tr>
    <tr>
      <td>Revoke any live URL in the account</td>
      <td>`Live Url (all) > Delete`</td>
    </tr>
  </tbody>
</table>
